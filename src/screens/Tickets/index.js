...
export default function Tickets() {
  ...
  {Seats.map(seat => (
    <Pressable 
      hitSlop={1} 
      style={[styles.seat, currentSelected.find(list => list.id === seat.id) ? {backgroundColor: '#ffa500'} : {}]} 
      onPress={() => setSelected(seat)} 
      key={seat.id}
      ...
      <View>
        ...
        <View style={{paddingHorizontal: 24, marginBottom: 50}}>
          ...
          <View style={styles.finishContainer}>
            ...
            <TouchableOpacity style={styles.btn} onPress={BuyTicket} activeOpacity={0.7}>
